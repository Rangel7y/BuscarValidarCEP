...
function UpdateTxtPg(){
    switch(currentTypeSwFrmMd){
        case typeSwFrmMd.typeFrmChkCep:
            ...
            secTxt2FrmChk.innerHTML = `Caso queira voltar ao modo de 'Validar CEP', <a href="#" onclick="SwMd()" title="Alternar para modo consulta de ENDEREÇO">clique aqui</a> para fazer a troca.`;
        ...
        case typeSwFrmMd.typeFrmChkAddress:
            ...
            secTxt2FrmChk.innerHTML = `Caso queira voltar ao modo de 'Consultar Endereço', <a href="#" onclick="SwMd()" title="Alternar para modo validação de CEP">clique aqui</a> para fazer a troca.`;
            break;
        default:
            break;
    }
